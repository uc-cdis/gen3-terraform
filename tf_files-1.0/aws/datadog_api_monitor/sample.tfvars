...
test_definitions = [
...

    {
        ...
        target_status_code = "200"
        target_response_time = "2000"
        name = "Discovery health check for: "
        message = "@slack-gpe-alarms The discovery health check failed for: "    
	test_run_frequency_secs = 900
    },

    {
        ...
        target_status_code = "200"
        target_response_time = "2000"
        name = "Fence health check for: "
        message = "@slack-gpe-alarms The Fence health check failed for: "    
	test_run_frequency_secs = 900
    },
